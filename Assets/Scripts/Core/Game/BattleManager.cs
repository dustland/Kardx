...
namespace Kardx.Core.Game
{
  public class BattleManager : MonoBehaviour
  {
    ...
    [SerializeField] private SharedState sharedState;
    [SerializeField] private PlayerState player1State;
    [SerializeField] private PlayerState player2State;
    ...
    private void ValidateReferences()
    {
      ...
      if (boardState == null) Debug.LogError("BoardState reference is missing!");
      if (sharedState == null) Debug.LogError("SharedState reference is missing!");
      if (player1State == null) Debug.LogError("Player1State reference is missing!");
      if (player2State == null) Debug.LogError("Player2State reference is missing!");
    }
