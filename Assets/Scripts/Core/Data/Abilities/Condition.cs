...
namespace Kardx.Core.Data.Abilities
{
  ...
  {
    [SerializeField] private string type;  // Condition type (e.g., "zone", "healthThreshold")
    [SerializeField] private string value;  // Condition value
    [SerializeField] private string operatorType;  // Comparison operator (e.g., "==", ">=", "<=")
    ...
    public static Condition CreateNumericCondition(string type, float value, string operatorType)
    {
