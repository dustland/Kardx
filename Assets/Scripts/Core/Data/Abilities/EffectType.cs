...
namespace Kardx.Core.Data.Abilities
{
    ...
    {
        [SerializeField]
        private EffectCategory category; // Effect type (e.g., "damage", "heal", "buff")

        [SerializeField]
        private string target; // "single", "area", "self"

        [SerializeField]
        private string formula; // Mathematical formula for effect calculation

        [SerializeField]
        private List<EffectAttribute> attributes = new(); // Parameters used in formula

        [SerializeField]
        private int? cooldown; // Turns until reuse (null = no cooldown)

        [SerializeField]
        private string animationKey; // Reference to visual effect

        [SerializeField]
        private string soundKey; // Reference to audio effect
    ...
    {
        [SerializeField]
        private string name; // Attribute identifier

        [SerializeField]
        private string valueType; // Type of the value (int, float, string)

        [SerializeField]
        private string serializedValue; // Serialized value as string
