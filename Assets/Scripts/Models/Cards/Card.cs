...
namespace Kardx.Models.Cards
{
    public class Card
    {
        ...
        private List<Kardx.Models.Match.Modifier> modifiers = new(); // Active temporary modifiers
        ...
        // Constructor
        public Card(CardType cardType, Faction ownerFaction = Faction.Neutral, Kardx.Models.Match.Player owner = null)
        {
        ...
        // Modifier management
        public void AddModifier(Kardx.Models.Match.Modifier modifier)
        {
            if (modifier != null)
            {
        ...
        public void RemoveModifier(Kardx.Models.Match.Modifier modifier)
        {
