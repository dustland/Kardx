# OpenCards 架构：设计原则和系统结构

[View English Version](./Arch.md)

_本文档提供 OpenCards 游戏的高级架构指导，概述核心设计原则、系统结构和组件交互。有关数据模型的详细信息，请参阅 [Data-CN.md](./Data-CN.md)。_

## 概述

OpenCards 架构旨在创建一个可维护、可测试和可扩展的代码库，能够随着游戏需求的发展而演变。其核心是强调关注点分离、单向数据流和组件之间的事件驱动通信。
