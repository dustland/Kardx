# OpenKards Ability System Design Document

[简体中文版](./Ability-CN.md)

## Overview

The OpenKards Ability System employs a **data-driven** design, providing a flexible framework for defining and executing card abilities in the game. Drawing inspiration from [Kards](https://kards.com) game mechanics, this system supports both basic ability types and complex strategic card effects.

### Core Design Principles

The OpenKards Ability System is built around four core design principles:
