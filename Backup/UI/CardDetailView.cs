...
namespace Kardx.UI
{
    ...
    public class CardDetailView : MonoBehaviour, IPointerClickHandler
    {
        ...
        [SerializeField]
        private float textAnimationDelay = 0.1f;

        [SerializeField]
        private float textAnimationDuration = 0.3f;

        [SerializeField]
        private bool useFlipEffect = true;

        [SerializeField]
        private float flipRotationAmount = 180f;
        ...
        private void PlayShowAnimation()
        {
            ...
            Sequence cardAnimation = DOTweenAnimationUtility.AnimateCardZoomIn(
                ...
                scaleInDuration,
                useFlipEffect ? flipRotationAmount : 0f  // Use flip effect if enabled
            );
