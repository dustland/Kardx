...
namespace Kardx.UI
{
    ...
    public class OpponentBattlefieldView : BaseBattlefieldView
    {
        ...
        public override void UpdateBattlefield()
        {
            ...
            for (int i = 0; i < slots.Count && i < Player.BATTLEFIELD_SLOT_COUNT; i++)
            {
        ...
        public void UpdateHighlights()
        {
            ...
            bool isCombatPhase = matchManager.Board.CurrentPhase == Phase.Combat;
            
            // Only highlight opponent cards during player's combat phase
            bool canTarget = isPlayerTurn && isCombatPhase;
