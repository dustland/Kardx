...
namespace Kardx.UI
{
    ...
    public class PlayerBattlefieldView : BaseBattlefieldView
    {
        ...
        public void UpdateHighlights()
        {
            ...
            // Only allow deployment during certain phases
            bool canDeploy = isPlayerTurn && (
                matchManager.Board.CurrentPhase == Phase.Deployment
            );
            
            // Update each slot's highlight state
            foreach (var slot in cardSlots)
            {
                slot.UpdateHighlight(canDeploy);
            }
        }
        ...
        public int GetCardCount()
        {
            ...
            return matchManager.Board.CurrentTurnPlayer.BattlefieldCards.Count();
        }
